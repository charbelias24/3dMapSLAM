...
Follow this article: [Setting up your NVIDIA environment](https://blog.jeremarc.com/setup/nvidia/cuda/linux/2020/09/19/nvidia-cuda-setup.html)
### 2.4.OctoMap
...
Note that it is possible to use other types of cameras as long as it publishes the image on a ROS topic.
